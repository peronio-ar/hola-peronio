import FinishWalletFondo from "../assets/images/FinishWallet/FinishWalletFondo2.svg";
        ...
        <Element name="finishWallet" className="finishWalletBackground">
            ...
            <div className="finishWalletContent">
                ...
                <div
                    className="piechart"
                    style={{
                        backgroundImage: `conic-gradient(#ec2929 ${(360 * counter) / 60}deg, transparent 0)`,
                    }}
                >
                ...
                <img src={CounterFinishWallet} alt="FinishWalletFondo" className="finishSunContainer" />
