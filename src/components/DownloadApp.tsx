...
export default function DownloadApp() {
    return (
        <div className='DownloadAppBackgorund'>
            <img src={DownloadAppFondo} alt="DownloadAppFondo" className='DownloadAppFondo' />
            <img src={LogoPeronioWhite} alt="LogoPeronioWhite" className='LogoPeronioWhite' />
            <img src={DownloadReloj} alt="DownloadReloj" className='DownloadReloj' />
            <div className='DownloadContent'>
                <img src={DownloadBarcode} alt="DownloadBarcode" className='DownloadBarcode' />

                <img src={downloadButton} alt="downloadButton" className='downloadButton' />
            </div>
