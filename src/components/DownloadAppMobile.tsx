...
export default function DownloadAppMobile({ handleClickBack, handleClickNext }: any) {
    return (
        <Element name="downloadAppMobile" className="mobileWelcomeContainer mobileWelcome">
