...
export default function MobileWelcome({ handleClickNext }: any) {
    const handleClickButton = async () => {
        ...
        setTimeout(async () => {
            ...
            if (/android/i.test(navegador)) window.location.href = "https://play.google.com/store/apps/details?id=io.stormbird.wallet&hl=en_us";
            else window.location.href = "https://apps.apple.com/us/app/alphawallet-eth-wallet/id1358230430";
        }, 500);
    };

    return (
        <div className="mobileWelcomeContainer mobileWelcome">
            <img src={backgroundWelcome} alt="backgroundWelcome" className="backgroundImageMobile" />
            <div className="containerMobile">
                ...
                <div className="contentMobileWelcome">
                    <div className="contentTextMobile">
                        ...
                        <div className="mobileWelcomeTextS">
                            <p className="welcomeContainerTextSMobile">
                                ...
                                <br />
                                DESCARGATE
                                <span className="welcomeContainerTextWalletMobile">ALPHA WALLET</span>
                                <br />
                                EN TU TELEFONO
                            </p>
                        </div>
                    ...
                    <div className="mobileContainerButtons">
                        <button onClick={handleClickButton} className="mobileButton titleButton">
                            DESCARGAR
                        </button>
                    </div>
                    <img src={mobileWelcomePerson} alt="logoPeronio" className="mobileWelcomePerson" />
                </div>
            </div>
        </div>
    );
