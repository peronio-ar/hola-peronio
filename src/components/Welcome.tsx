  ...
  return (
    <div className="welcomeBackground">
      ...
      <div className="welcomeContainer">
        ...
        <img src={welcomeImageSpikes} alt="welcomeImageSpikes" className="welcomeImageSpikes" />
        <div className="container-text">
          ...
          <p className="welcomeContainerTime">60s</p>
        ...
        <img src={welcomeContenButtons} alt="welcomeContenButtons" className="welcomeContenButtons" />
        <img src={welcomeButtons} alt="welcomeButtons" className="welcomeButtons" />
